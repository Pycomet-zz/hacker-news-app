...
class TestAPI(unittest.TestCase):
    ...
    def test_get_single_news(self):
        ...
        res1 = requests.get(
            "http://127.0.0.1:8080/api/v1/news/32953111").json()  # valid
        res2 = requests.get(
            "http://127.0.0.1:8080/api/v1/news/00053732").json()  # invalid
        assert res1['code'] == 200
        assert res2['code'] == 404

    def test_post_single_news(self):
        "test creating new uniques news to DB"
        res1 = requests.post("http://127.0.0.1:8080/api/v1/news/32953732", json={
            "by": "codefred",
            "type": "job",
            "time": 2436273623,
            "deleted": False,
